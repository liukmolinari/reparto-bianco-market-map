const CACHE='rb-market-map-v1d';
const APP=['./','./index.html','./styles.css','./app.js','./stores.js','./manifest.webmanifest','./icon-192.png','./icon-512.png','./logo-mediaworld.png','./logo-unieuro.png','./logo-euronics.png','./logo-trony.png','./logo-comet.png'];
